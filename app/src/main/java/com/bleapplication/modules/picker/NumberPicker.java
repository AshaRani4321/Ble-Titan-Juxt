package com.bleapplication.modules.picker;
...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final float FADING_EDGE_STRENGTH = 20.5f;

    /**
     * The default unscaled height of the selection divider.
     */
    private static final int UNSCALED_DEFAULT_SELECTION_DIVIDER_THICKNESS = 1;

    /**
     * The default unscaled distance between the selection dividers.
     */
    private static final int UNSCALED_DEFAULT_SELECTION_DIVIDERS_DISTANCE = 58;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectionDivider = ContextCompat.getDrawable(context, R.color.dt_transparent);
    ...
    public void setTheValue(int value) {
      //  Log.d("NUMBER_PICKER", "setTheValue: " + value);
...
//        setWrapSelectorWheel(wrapSelectorWheel);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mSelectionDivider != null) {
            if (isHorizontalMode()) {
                ...
                //TODO-Enable TO draw the top DIVIDER
    ...
    private void setValueInternal(int current, boolean notifyChange) {
     //   Log.e("NUMBER_PICKER", "setValueInternal: CURRENT" + current + "  MVALUE " + mValue);
        if (mValue == current) {
            return;
        }
        ...
        if (notifyChange) {
         ...
         //   Log.e("NUMBER_PICKER", "setValueInternal: " + previous + "  CURRENT " + current);
        }
        initializeSelectorWheelIndices();
        invalidate();
    }
